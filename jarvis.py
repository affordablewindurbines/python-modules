...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Tue Feb  9 01:05:41 2016
#
...
if __name__ == "__main__":
    ...
    print("*******************************************************")
    print("*             JARVIS THE SMART ASSISTANT              *")
    print("* (c) 2016 JOHNNY HEATH                               *")
    print("*******************************************************")
...
if __name__ == "__main__":
    gettext.install("jarvis") # replace with the appropriate catalog name

    jarvis = wx.PySimpleApp(0)
    wx.InitAllImageHandlers()
    frame_1 = MyFrame(None, wx.ID_ANY, "")
    jarvis.SetTopWindow(frame_1)
    frame_1.Show()
    jarvis.MainLoop()
